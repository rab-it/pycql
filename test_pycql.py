...
connection.setup(['localhost:9160', 'localhost:9145'])
execute_obj = connection.execute("INSERT INTO quantweb.USERS(uid,reg, username, email) VALUES (62c36092-82a1-3a00-93d1-46196ee77212, '1000',  'cokai', 'cokai@test.com');")